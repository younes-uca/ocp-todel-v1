...
@Component({
  selector: 'app-classe-room-create-admin',
  templateUrl: './classe-room-create-admin.component.html'
})
export class ClasseRoomCreateAdminComponent extends AbstractCreateController<ClasseRoomDto, ClasseRoomCriteria, ClasseRoomService>  implements OnInit {
   ...
   private _validClasseRoomNiveau = true;
    ...
    const isPermistted = await this.roleService.isPermitted('Niveau', 'add');
    if(isPermistted) {
         this.niveau = new NiveauDto();
