...
@Component({
  selector: 'app-matiere-edit-admin',
  templateUrl: './matiere-edit-admin.component.html'
})
export class MatiereEditAdminComponent extends AbstractEditController<MatiereDto, MatiereCriteria, MatiereService>   implements OnInit {
