...
@Component({
  selector: 'app-professeur-edit-admin',
  templateUrl: './professeur-edit-admin.component.html'
})
export class ProfesseurEditAdminComponent extends AbstractEditController<ProfesseurDto, ProfesseurCriteria, ProfesseurService>   implements OnInit {
