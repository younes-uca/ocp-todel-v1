...
@Component({
  selector: 'app-niveau-create-admin',
  templateUrl: './niveau-create-admin.component.html'
})
export class NiveauCreateAdminComponent extends AbstractCreateController<NiveauDto, NiveauCriteria, NiveauService>  implements OnInit {
