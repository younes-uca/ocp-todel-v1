...
@Component({
  selector: 'app-discipline-edit-admin',
  templateUrl: './discipline-edit-admin.component.html'
})
export class DisciplineEditAdminComponent extends AbstractEditController<DisciplineDto, DisciplineCriteria, DisciplineService>   implements OnInit {
