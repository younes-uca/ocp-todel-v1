...
@Component({
  selector: 'app-note-discipline-create-admin',
  templateUrl: './note-discipline-create-admin.component.html'
})
export class NoteDisciplineCreateAdminComponent extends AbstractCreateController<NoteDisciplineDto, NoteDisciplineCriteria, NoteDisciplineService>  implements OnInit {
