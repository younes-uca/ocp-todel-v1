package ma.sir.ocp.zynerator.converter;


import ma.sir.ocp.zynerator.bean.Etablissement;
import ma.sir.ocp.zynerator.dto.EtablissementDto;

import ma.sir.ocp.zynerator.util.ListUtil;
import ma.sir.ocp.zynerator.audit.AuditBusinessObject;
import ma.sir.ocp.zynerator.bean.BusinessObject;
import ma.sir.ocp.zynerator.dto.AuditBaseDto;
import ma.sir.ocp.zynerator.dto.BaseDto;
import ma.sir.ocp.zynerator.util.DateUtil;
import ma.sir.ocp.zynerator.util.RefelexivityUtil;
import ma.sir.ocp.zynerator.util.StringUtil;
import ma.sir.ocp.zynerator.util.Utils;
