package ma.sir.ocp.zynerator.security.jwt;
...
import ma.sir.ocp.OcpApplication;
import ma.sir.ocp.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = OcpApplication.getCtx().getBean(UserService.class);
